...
class OpTest(BaseModel):
    ...
    # `model_name` below collides with pydantic's reserved `model_` namespace (used for
    # its own `model_*` methods/attributes); disable that protected-namespace check since
    # this field name is part of our external data schema and won't be renamed.
